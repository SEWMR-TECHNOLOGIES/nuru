...
import { Calendar, Users, UserCheck, Edit2, Trash2, Loader2, FileText } from 'lucide-react';
  ...
  const handleStatusChange = async (eventId: string, newStatus: string) => {
    ...
    try {
      if (newStatus === 'published') {
        ...
        // For draft/completed, use update with FormData
  ...
  if (loading) {
    return (
      <div className="h-full overflow-y-auto">
        <div className="flex items-center justify-between mb-6"><Skeleton className="h-8 w-32" /><Skeleton className="h-9 w-28" /></div>
                      ...
                      <div className="flex flex-wrap items-center gap-2 mt-4">
                        ...
                        <button onClick={(e) => {
                          ...
                          generateEventReport({
                            ...
                            pending_guest_count: event.pending_guest_count,
                            declined_guest_count: event.declined_guest_count,
                            checked_in_count: event.checked_in_count,
                            committee_count: event.committee_count,
                            contribution_total: event.contribution_total,
                            contribution_count: event.contribution_count,
                            contribution_target: event.contribution_target,
