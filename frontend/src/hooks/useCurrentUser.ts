...
const normalizeUserPayload = (raw: any): User | null => {
  ...
  return {
    ...
    country_code: raw.country_code ?? profile.country_code ?? null,
    currency_code: raw.currency_code ?? profile.currency_code ?? null,
    country_source: raw.country_source ?? profile.country_source ?? null,
