      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (_) => DirectionsScreen(
            destinationLat: lat!,
            destinationLng: lng!,
            venueName: venue.isNotEmpty ? venue : (location.isNotEmpty ? location : null),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Location', style: appText(size: 11, color: AppColors.textTertiary, weight: FontWeight.w500)),
                                const SizedBox(height: 2),
                                Text(
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('Directions', style: appText(size: 11, weight: FontWeight.w700, color: Colors.white)),
                              ],
                            ),
                          ),
                        ],
